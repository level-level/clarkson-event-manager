...
class Fields {
    const DATE_START = "clarkson_event_manager_date_start";
    const DATE_START_TIME = "clarkson_event_manager_date_start_time";
    const DATE_END = "clarkson_event_manager_date_end";
